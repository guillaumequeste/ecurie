        ...
        <div className="divBilan">
          <div className="result">
            <p className="pReussite">
              <strong>RMC 2013</strong> : {this.state.courses_2013} courses,{" "}
          ...
          <div className="result result2">
            <p className="pReussite">
              <strong>RMC 2014</strong> : {this.state.courses_2014} courses,{" "}
          ...
          <div className="result result2">
            <p className="pReussite">
              <strong>RMC 2015</strong> : {this.state.courses_2015} courses,{" "}
          ...
          <div className="result result2">
            <p className="pReussite">
              <strong>Club RMC</strong> : {this.state.courses_rmc} courses,{" "}
          ...
          <div className="result result2">
            <p className="pReussite">
              <strong>Ecurie Top</strong> : {this.state.courses_top} courses,{" "}
