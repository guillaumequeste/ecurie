        ...
        return (
            <div className="bodyBilan">
                ...
                <div className="divBilan">
                    ...
                    <hr />
                    <div className="result result2">
                        <p className="pReussite"><strong>XXL</strong> : 65 courses, 7 victoires, 30 places</p>
                        <p className="reussite">56,9% de réussite (10,7% à la gagne)</p>
                    </div>
                    <hr />
                    <div className="result result2">
                    ...
                    <hr />
                    <div className="result result2">
                        <p className="pReussite"><strong>TOTAL</strong> : 735 courses, 63 victoires, 330 places</p>
                        <p className="reussite">53,4% de réussite (8,5% à la gagne)</p>
                    </div>
                </div>
            </div>
        )
